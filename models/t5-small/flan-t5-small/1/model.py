...
class TritonPythonModel:
    """Triton Python model for flan-t5-small translation."""
    ...
    def initialize(self, args):
        ...
        model_name = args.get('model_name', 'flan-t5-small')
        model_repository = args.get('model_repository', '/mnt/models')
        
        # Try to find model.json - handle both /mnt/models and /mnt/models/flan-t5-small as repository
